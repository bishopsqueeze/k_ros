...
##                        is started anew. E.g. "Feb,May,Aug,Nov" means each round starts in
...
##------------------------------------------------------------------
samp_sub.raw	<- read.csv("/Users/alexstephens/Development/kaggle/rossmann/data/raw/sample_submission.csv", header=TRUE)
store.raw		<- read.csv("/Users/alexstephens/Development/kaggle/rossmann/data/raw/store.csv", header=TRUE)
train.raw		<- read.csv("/Users/alexstephens/Development/kaggle/rossmann/data/raw/train.csv", header=TRUE)
test.raw		<- read.csv("/Users/alexstephens/Development/kaggle/rossmann/data/raw/test.csv", header=TRUE)

##------------------------------------------------------------------
## Write the raw data to an .Rdata file
##------------------------------------------------------------------
save(samp_sub.raw, store.raw, train.raw, test.raw, file="001_rossmann.Rdata")
